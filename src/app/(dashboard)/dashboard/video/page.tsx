...
import { Video, ShieldCheck, Zap, Info } from 'lucide-react';
    ...
    <div className="space-y-8 pb-12">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-air-sup-blue mt-0.5">Detect deepfakes and manipulation.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
        <div className="xl:col-span-3 space-y-6">
          <div className="glass-card rounded-2xl p-6 space-y-5">
            <FileDropzone
              ...
              acceptedTypes={{ 'video/*': ['.mp4', '.mov', '.webm'] }}
        ...
        <div className="xl:col-span-2 space-y-4">
            <div className="glass-card rounded-2xl p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-air-sup-blue mt-2">Upload a video and run analysis to see AI detection results here.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 space-y-5">
              ...
              <p className="text-xs text-ucla-blue leading-relaxed">
                Upload your video, and our AI models will analyze temporal frames, motion consistency, and facial artifacts to detect potential manipulation.
              </p>
            </div>
        </div>
      </div>
