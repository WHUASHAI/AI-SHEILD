...
import { ImageIcon, ShieldCheck, Zap, Info } from 'lucide-react';
    ...
    <div className="space-y-8 pb-12">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-air-sup-blue mt-0.5">Analyze images for AI generation patterns.</p>
        </div>
      </div>
        ...
        <div className="xl:col-span-2 space-y-4">
            ...
            <div className="glass-card rounded-2xl p-6 space-y-5">
              ...
              <p className="text-xs text-ucla-blue leading-relaxed">
                Upload your image, and our AI models will analyze for subtle artifacts, inconsistency, and synthetic patterns.
              </p>
            </div>
        </div>
      </div>
